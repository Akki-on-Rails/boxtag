...
ActiveRecord::Schema.define(version: 2022_08_13_090319) do
  ...
  create_table "collections", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["user_collection_id"], name: "index_collections_on_user_collection_id"
  end
  ...
  add_foreign_key "boxes", "collections"
  add_foreign_key "collections", "user_collections"
